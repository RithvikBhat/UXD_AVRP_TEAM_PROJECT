...
namespace Leap.Unity.Interaction.Keyboard
{
    public class Keyboard : MonoBehaviour
    {
        ...
        private void HandleKeyUpEncoding(string _keyCodeString)
        {
            ...
            if (OnUpdate != null)
            {
                OnUpdate?.Invoke(System.Text.Encoding.UTF8.GetBytes(_keyCodeString));
            }
        ...
        private bool AccentPanelActive()
        {
        ...
        private void ModeSwitch(string _key)
        {
            switch (_key)
            {
                case "shift":
        ...
        private void ShowAccentOverlay(List<string> specialChars, Keyboard source, Transform keyTransform = null)
        {
            if (source != this) { return; };
