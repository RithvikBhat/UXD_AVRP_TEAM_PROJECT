...
public class InteractionGlow : MonoBehaviour {
    ...
    [Tooltip("This color only applies if the object is an InteractionToggle.")]
    ...
    void Start() {
        ...
        if (renderer != null) {
            ...
            for (int i = 0; i < renderer.materials.Length; i++) {
                _materials[i] = renderer.materials[i];
            }
        }
    }
    ...
    void Update() {
        ...
        if (_materials != null) {
            ...
            Color targetColor = _materials[1].color;
            ...
            _materials[0].color = Color.Lerp(_materials[0].color, targetColor, 30F * Time.deltaTime);



            // BACK - Color
            if (_intObj is InteractionToggle && (_intObj as InteractionToggle).isToggled) {
            ...
            // Lerp actual material color to the target color.
            _materials[1].color = Color.Lerp(_materials[1].color, targetColor, 30F * Time.deltaTime);
        }
    }
}
