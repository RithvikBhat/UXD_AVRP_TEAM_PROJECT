...
namespace Leap.Unity.Examples
{
    ...
    public class ThickRibbonRenderer : MonoBehaviour
    {
        ...
        /// </summary>
        public GameObject FinalizedRibbonParent;
        ...
        public void InitializeRenderer()
        {
            ...
            MeshRenderer.material = new Material(RibbonMaterial);
        ...
        public void FinalizeRenderer()
        {
            ...
            meshObj.transform.parent = FinalizedRibbonParent.transform;
